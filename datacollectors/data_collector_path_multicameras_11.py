    ...
    def _parse_image(weak_self, image, position: str, agent: BasicAgent, traffic_manager: carla.TrafficManager):
        ...
        if self.recording:
            ...
            if traffic_manager is not None:
                ...
                np.savez(f'../../dataset_multicamera_11_3/%08d_{position}' % image.frame, x=array, y=label)
...
def game_loop(args):
    ...
    try:
        ...
        while True:
            ...
            print(f"TIME: {hud.simulation_time} and SPEED: {current_speed} and INTENTION: {camera_manager.hlc}")
            noise_counter += 1
