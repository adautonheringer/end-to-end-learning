...
class World(object):
    ...
    def __init__(self, carla_world, hud, args):
        ...
        self.start_transform = carla.Transform(self.start_location, carla.Rotation(yaw=90))
        self.restart(args)
    ...
    def restart(self, args):
        ...
        while self.player is None:
            ...
            self.player = self.world.try_spawn_actor(blueprint, self.start_transform)
            self.modify_vehicle_physics(self.player)
...
def game_loop(args):
    ...
    try:
        ...
        # agent.set_destination(end_location=where_to)
        ...
        locations = [start_location, end_location, back_location]
        path_list = []
        for i in range(30):
            path_list += locations
        ...
        while True:
            ...
            print(f"TIME: {hud.simulation_time} and SPEED: {current_speed}")
            noise_counter += 1
